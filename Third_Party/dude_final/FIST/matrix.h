...
#define InitIdentity(matrix)                                                   \
  {                                                                            \
    (matrix).element[0][1] = (matrix).element[0][2] = (matrix).element[0][3] = \
        0.0;                                                                   \
    ...
    (matrix).element[3][0] = (matrix).element[3][1] = (matrix).element[3][2] = \
        0.0;                                                                   \
    (matrix).element[0][0] = (matrix).element[1][1] = (matrix).element[2][2] = \
        1.0;                                                                   \
...
#define MatrixTransformation(matrix, pnt, new_pnt)                             \
  {                                                                            \
    (new_pnt).x = (pnt).x * (matrix).element[0][0] +                           \
                  ...
                  (pnt).z * (matrix).element[2][0] + (matrix).element[3][0];   \
    (new_pnt).y = (pnt).x * (matrix).element[0][1] +                           \
                  (pnt).y * (matrix).element[1][1] +                           \
                  (pnt).z * (matrix).element[2][1] + (matrix).element[3][1];   \
    (new_pnt).z = (pnt).x * (matrix).element[0][2] +                           \
                  (pnt).y * (matrix).element[1][2] +                           \
                  (pnt).z * (matrix).element[2][2] + (matrix).element[3][2];   \
  }
