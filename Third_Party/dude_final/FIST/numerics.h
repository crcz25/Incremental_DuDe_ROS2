...
/* points!                                                                   */
/*                                                                           */
#define InBetween(i1, i2, i3) ((i1 <= i3) && (i3 <= i2))

#define StrictlyInBetween(i1, i2, i3) ((i1 < i3) && (i3 < i2))
...
#define Orientation(i, j, k, ori)                                              \
  {                                                                            \
    StableDet2D(i, j, k, numerics_h_det);                                      \
                                                                               \
    if (lt(numerics_h_det, ZERO))                                              \
      ori = -1;                                                                \
    else if (gt(numerics_h_det, ZERO))                                         \
      ori = 1;                                                                 \
    else                                                                       \
      ori = 0;                                                                 \
  }
