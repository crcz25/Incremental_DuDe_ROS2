...
#define BBox_Contained(bb1, bb2)                                               \
  (++bb_cntr, ((bb1).imin <= (bb2).imin) && ((bb1).imax >= (bb2).imax) &&      \
...
#define BBox_Area(bb, area)                                                    \
  {                                                                            \
    area =                                                                     \
        (points[(bb).imax].x - points[(bb).imin].x) * ((bb).ymax - (bb).ymin); \
  }
...
#define BBox_Enlarge(bb1, bb2)                                                 \
  {                                                                            \
    if ((bb1).imin < (bb2).imin)                                               \
      (bb2).imin = (bb1).imin;                                                 \
    if ((bb1).imax > (bb2).imax)                                               \
      (bb2).imax = (bb1).imax;                                                 \
...
#define BBox_Overlap_Extended(bb1, bb2)                                        \
  (++bb_cntr,                                                                  \
   (((bb1).ymax < (bb2).ymin)                                                  \
        ...
        : (((bb1).ymin > (bb2).ymax)                                           \
               ? false                                                         \
               : (((bb1).xmax < points[(bb2).imin].x)                          \
                      ? false                                                  \
                      : (((bb1).xmin > points[(bb2).imax].x) ? false           \
                                                             : true)))))
#else
#define BBox_Overlap_Extended(bb1, bb2)                                        \
  ((((bb1).ymax < (bb2).ymin)                                                  \
