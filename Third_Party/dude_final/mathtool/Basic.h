...
template <class T> int round(T x, int p) {
  return (
      long int)(((long int)((x)*std::pow(10.0, p) + ((x) < 0 ? -0.5 : 0.5))) /
                std::pow(10.0, p));
}
...
////////////////////////////////////////////////////////////////////////////////////////
// Following functions define M_PI and drand48, which are not starndard c
// library and definitions. In addition, rint used to round off float points to
// int is also here.
/////////////////////////////////////////////////////////////////////////////////////////
