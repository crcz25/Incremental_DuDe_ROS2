 ...
 *     <a href
 *="https://blackwidowers.cs.tamu.edu/stapldoc/graph/newgraph.ps">[ps]</a><a
 *href
 *="https://blackwidowers.cs.tamu.edu/stapldoc/graph/newg/index.html">[html]</a>
 *
...
public:
  ...
  void SetEdgeId(int __id) { edgeid = __id; }
...
public:
  ...
  vector<WtEdge>
      predecessors; ///< call BaseGraph::SetPredecessors() to initialize
  ...
  void SetEdgeIdCnt(int _cnt) { edgeid_cnt = _cnt; }
  ...
  COLOR SetColorOut(int _tr_id, COLOR _color) {
    ...
    //   cout<<"somebody touching"<<vid<<": to set the color
    //   "<<_color<<":"<<stapl::get_thread_id()<<endl;
    // }
  ...
  void SetDependencies(int _tr_id) {
    ...
    // if(vid == 4994 || vid== 5016 || vid== 5038 || vid==5060){
    //   cout<<"INSIDE::"<<_tr_id<<":"<<vid<<":"<< predecessors.size()<<":"<<
    //   edgelist.size()<<endl;
    // }
  }
...
private:
public:
  inline void SetNumEdges(int _ne) { numEdges = _ne; }
  inline int GetNumEdges() const { return numEdges; }
  inline void SetNumVerts(int _ne) { numVerts = _ne; }
  ...
  inline VID getVertIDs() const { return vertIDs; }
...
public:
  bool operator()(T a, T b) { return a.vid > b.vid; }
};

template <class T> class comparebypid {
public:
  bool operator()(T a, T b) { return a.pid <= b.pid; }
};
...
public:
   ...
   *@return ERROR if v1 and/or v2 are not found. OK if ok.
   */
  int DeleteWtEdge(VERTEX &, VERTEX &, WEIGHT,
   ...
   *@param The vector were the ids will be stored; the method will clear this
   *vector before filling in; return the number of elements that were pushed in
   *the vector
   */
   ...
   *@param verts The vector were the data will be stored; the method will clear
   *this vector before filling in; return the number of data elements that were
   *pushed in the vector
   */
  ...
  /**Return the id that will be allocated to the next vertex to be inserted in
   * graph
   */
  ...
  VI begin() { return v.begin(); }
  CVI begin() const { return v.begin(); }
  VI end() { return v.end(); }
  CVI end() const { return v.end(); }
...
#ifdef _TESTBGRAPH
  void SetV(const BaseGraph<VERTEX, WEIGHT> &_g) { v = _g.v; }
  ...
  //===========================
  const map<VID, int> &GetLocalIDMap() const { return gid_localid_map; }

  void SetLocalIDMap(const map<VID, int> &_m) { gid_localid_map = _m; }
  ...
  void DisplayVIDLocalIDMap() {
    for (map<VID, int>::iterator it = gid_localid_map.begin();
      ...
      cout << "VID : " << it->first << "  with Local ID: " << it->second
           << endl;
    }
  }
#endif
...
template <class VERTEX, class WEIGHT> BaseGraph<VERTEX, WEIGHT>::BaseGraph() {}

template <class VERTEX, class WEIGHT>
BaseGraph<VERTEX, WEIGHT>::BaseGraph(int _sz) {
  v.reserve(_sz);
}

template <class VERTEX, class WEIGHT>
BaseGraph<VERTEX, WEIGHT>::BaseGraph(int _sz, int _edgelistsz)
...
template <class VERTEX, class WEIGHT>
VID BaseGraph<VERTEX, WEIGHT>::AddVertex(VERTEX &_v) {
...
template <class VERTEX, class WEIGHT>
VID BaseGraph<VERTEX, WEIGHT>::AddVertex(vector<VERTEX> &_v) {
...
template <class VERTEX, class WEIGHT>
VID BaseGraph<VERTEX, WEIGHT>::AddVertex(const VERTEX &_v, VID _vid) {
  VID vid = _vid;
  Vertex newVertex(_v, vid, this->reserveEdgesPerVertex);
  v.push_back(newVertex);
#ifdef DYNAMIC_GRAPH
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteVertex(VERTEX &_v1) {
  VI v1;
  if (IsVertex(_v1, &v1)) {
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteVertex(VID _v1id) {
  VI v1;
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteVertices(vector<VID> &_vv) {
...
#ifdef DYNAMIC_GRAPH
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::UpdateMap() {
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::EraseGraph() {
  v.clear();
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetVertexCount() const {
  return v.size();
}

template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetEdgeCount() const {
  return this->numEdges;
}

template <class VERTEX, class WEIGHT>
VID BaseGraph<VERTEX, WEIGHT>::GetNextVID() const {
  return this->vertIDs;
}

template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::PutData(VID _vid, VERTEX _v) {
  VI v1;
  if (IsVertex(_vid, &v1)) {
    v1->data = _v;
  }
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::SetStartID(VID _startvid) {
  this->vertIDs = _startvid;
}

template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::SetnumVerts(int _num) {
  this->numVerts = _num;
}
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::SetnumEdges(int _num) {
  this->numEdges = _num;
}

template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DisplayGraph() const {
  CVI vi;
  int i;
  cout << endl;
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::AddEdge(VID _v1id, EI _ei) {
  VI v1, v2;
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::AddEdge(VID _v1id, VID _v2id, WEIGHT _weight) {
  VI v1;
  int res = OK;
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::AddEdge(VID _v1id, VID _v2id,
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::AddEdge(VERTEX &_v1, VERTEX &_v2,
                                       WEIGHT _weight) {
  int res = OK;
  VI v1, v2;
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsEdge(VID _v1id, VID _v2id, VI *_v1ptr,
                                       EI *_e12ptr) {
  VI v1;
  EI e12;
  if (IsVertex(_v1id, &v1)) {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsEdge(VID _v1id, VID _v2id) {
  VI v1;
  EI e12;
  if (IsVertex(_v1id, &v1)) {
    if (v1->IsEdge(_v2id, &e12)) {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsEdge(VID _v1id, VID _v2id, WEIGHT _weight,
                                       VI *_v1ptr, EI *_e12ptr) {
  VI v1;
  EI e12;
  if (IsVertex(_v1id, &v1)) {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsEdge(VERTEX &_v1, VERTEX &_v2, VI *_v1ptr,
                                       EI *_e12ptr) {
  VI v1, v2;
  EI e12;
  if (IsVertex(_v1, &v1) && IsVertex(_v2, &v2)) {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsEdge(VERTEX &_v1, VERTEX &_v2, WEIGHT _weight,
                                       VI *_v1ptr, EI *_e12ptr) {
  VI v1, v2;
  EI e12;
  if (IsVertex(_v1, &v1) && IsVertex(_v2, &v2)) {
...
#ifdef _PGRAPH
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsEdgeId(VID _v1id, int _edgeid, VI *_v1ptr,
                                         EI *_e12ptr) {
  VI v1;
  EI e12;
  if (IsVertex(_v1id, &v1)) {
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DeleteAllEdgesToV(VID _v2id) {
  CVI v2;
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DeleteAllEdgesFromV(VID _v1id) {
  VI v1;
  if (IsVertex(_v1id, &v1)) {
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DeleteAllEdges(VID _vid) {
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteEdge(VID _v1id, VID _v2id, int _n) {
  VI v1;
  if (IsVertex(_v1id, &v1)) {
...
#ifdef _PGRAPH
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteEdgeId(VID _v1id, int _edgeid) {
  VI v1;
  if (IsVertex(_v1id, &v1)) {
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteWtEdge(VID _v1id, VID _v2id,
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DeleteAllEdgesToV(VERTEX &_v2) {
  CVI v2;
  if (IsVertex(_v2, &v2)) {
    for (VI vi = v.begin(); vi < v.end(); vi++) {
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DeleteAllEdgesFromV(VERTEX &_v1) {
  VI v1;
  if (IsVertex(_v1, &v1)) {
    this->numEdges -= v1->edgelist.size();
    v1->edgelist.erase(v1->edgelist.begin(), v1->edgelist.end());
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::DeleteAllEdges(VERTEX &_v) {
...
// default: delete all edges (v1,v2), otherwise delete _n
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteEdge(VERTEX &_v1, VERTEX &_v2, int _n) {
  VI v1, v2;
  if (IsVertex(_v1, &v1) && IsVertex(_v2, &v2)) {
...
// default: delete all edges (v1,v2) of specified weight, otherwise delete _n
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::DeleteWtEdge(VERTEX &_v1, VERTEX &_v2,
                                            WEIGHT _weight, int _n) {
  VI v1, v2;
  if (IsVertex(_v1, &v1) && IsVertex(_v2, &v2)) {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsVertex(VID _v1id) const {
  CVI v1;
  return (IsVertex(_v1id, &v1));
}

template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsVertex(VID _v1id, CVI *_v1ptr) const {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsVertex(VID _v1id, VI *_v1ptr) {
  // non constant stuff
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsVertex(VERTEX &_v1) const {
  CVI v1;
  return (IsVertex(_v1, &v1));
}

template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsVertex(VERTEX &_v1, CVI *_v1ptr) const {
...
template <class VERTEX, class WEIGHT>
bool BaseGraph<VERTEX, WEIGHT>::IsVertex(VERTEX &_v1, VI *_v1ptr) {
  // non constant stuff
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetVerticesVID(vector<VID> &verts) const {
  verts.clear();
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetVerticesVID(vector<VID> &verts, VID _vid,
                                              int _n) const {
  verts.clear();
  verts.reserve(_n);
  CVI v1, v2;
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetVerticesData(vector<VERTEX> &verts) const {
  verts.clear();
  verts.reserve(v.size());
  for (CVI vi = v.begin(); vi < v.end(); vi++) {
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetVerticesData(vector<VERTEX> &verts, VID _vid,
                                               int _n) const {
  verts.clear();
  verts.reserve(_n);
  CVI v1, v2;
...
template <class VERTEX, class WEIGHT>
VERTEX BaseGraph<VERTEX, WEIGHT>::GetData(VID _v1id) const {
  CVI v1;
  if (IsVertex(_v1id, &v1)) {
    return v1->data;
  } else {
...
template <class VERTEX, class WEIGHT>
VERTEX *BaseGraph<VERTEX, WEIGHT>::GetReferenceofData(VID _v1id) {
  VI v1;
  if (IsVertex(_v1id, &v1)) {
    return (&v1->data);
  } else {
...
template <class VERTEX, class WEIGHT>
void BaseGraph<VERTEX, WEIGHT>::GetAllEdgesToV(
    VID _v, vector<pair<VID, WEIGHT>> &ToEdges) {
  VI vi2;
...
template <class VERTEX, class WEIGHT>
int BaseGraph<VERTEX, WEIGHT>::GetData(vector<VERTEX> &vset, VID _v1id,
                                       VID _v2id) const {
  CVI v1, v2;
  vset.clear();
  if (IsVertex(_v1id, &v1) && IsVertex(_v2id, &v2)) {
...
template <class VERTEX, class WEIGHT>
VID BaseGraph<VERTEX, WEIGHT>::GetVID(VERTEX &_v1) const {
  CVI v1;
  if (IsVertex(_v1, &v1)) {
    return v1->vid;
  } else {
...
BaseGraph<VERTEX, WEIGHT>::my_find_VID_eq(const VID _vid) {
  VI vi, startvi;
...
BaseGraph<VERTEX, WEIGHT>::my_find_VID_eqc(const VID _vid) const {
  CVI vi, startvi;
...
/* typename vector<typename BaseGraph<VERTEX,WEIGHT>::Vertex >::iterator */
typename vector<WtVertexType<VERTEX, WEIGHT>>::iterator
BaseGraph<VERTEX, WEIGHT>::my_find_VDATA_eq(const VERTEX &_v) {
  VI vi = v.begin();
  bool found = false;
...
/* typename vector<typename BaseGraph<VERTEX,WEIGHT>::Vertex>::const_iterator */
typename vector<WtVertexType<VERTEX, WEIGHT>>::const_iterator
BaseGraph<VERTEX, WEIGHT>::my_find_VDATA_eqc(const VERTEX &_v) const {
  CVI vi = v.begin();
  bool found = false;
  while (vi != v.end() && !found) {
    if (vi->data == _v) {
...
template <class VERTEX, class WEIGHT>
WtVertexType<VERTEX, WEIGHT>::WtVertexType(const VERTEX &_data, VID _id) {
  data = _data;
  vid = _id;
...
template <class VERTEX, class WEIGHT>
int WtVertexType<VERTEX, WEIGHT>::AddEdge(VID _v2id, WEIGHT _weight) {
  int res = OK;
...
template <class VERTEX, class WEIGHT>
int WtVertexType<VERTEX, WEIGHT>::AddEdgewCheck(VID _v2id, WEIGHT _weight) {
  int res = OK;
  bool found;
...
#ifdef _PGRAPH
template <class VERTEX, class WEIGHT>
int WtVertexType<VERTEX, WEIGHT>::DeleteEdgeId(int _edgeid) {
...
template <class VERTEX, class WEIGHT>
bool WtVertexType<VERTEX, WEIGHT>::IsEdge(VID _v2id, CEI *_ei) const {
...
template <class VERTEX, class WEIGHT>
bool WtVertexType<VERTEX, WEIGHT>::IsEdge(VID _v2id, EI *_ei) {
  EI ei = my_find_EID1_eq(_v2id);
  if (ei != edgelist.end()) {
    *_ei = ei;
    return true;
...
template <class VERTEX, class WEIGHT>
bool WtVertexType<VERTEX, WEIGHT>::IsEdge(VID _v2id, WEIGHT _weight, EI *_ei) {
...
#ifdef _PGRAPH
template <class VERTEX, class WEIGHT>
bool WtVertexType<VERTEX, WEIGHT>::IsEdgeId(int _edgeid, EI *_ei) {
  EI ei;
...
template <class VERTEX, class WEIGHT>
bool WtVertexType<VERTEX, WEIGHT>::IsEdgeId(int _edgeid, CEI *_ei) const {
  CEI ei;
...
template <class VERTEX, class WEIGHT>
VERTEX &WtVertexType<VERTEX, WEIGHT>::GetData() {
  return data;
}

template <class VERTEX, class WEIGHT>
const VERTEX &WtVertexType<VERTEX, WEIGHT>::GetData() const {
  return data;
}

template <class VERTEX, class WEIGHT>
VERTEX &WtVertexType<VERTEX, WEIGHT>::GetUserData() {
  return data;
}

template <class VERTEX, class WEIGHT>
const VERTEX &WtVertexType<VERTEX, WEIGHT>::GetUserData() const {
  return data;
}

template <class VERTEX, class WEIGHT>
void WtVertexType<VERTEX, WEIGHT>::SetUserData(const VERTEX &_data) {
  data = _data;
}

template <class VERTEX, class WEIGHT>
void WtVertexType<VERTEX, WEIGHT>::SetUserData(VERTEX &_data) {
  data = _data;
}
...
#ifdef _PGRAPH
template <class VERTEX, class WEIGHT>
WEIGHT WtVertexType<VERTEX, WEIGHT>::GetEdgeIdWeight(int edgeid) const {
  CEI ei;
...
WtVertexType<VERTEX, WEIGHT>::find_edgeid_eq(const EID _edgeid) const {
  CEI ei;
...
WtVertexType<VERTEX, WEIGHT>::find_edgeid_eq(const EID _edgeid) {
  EI ei;
...
template <class VERTEX, class WEIGHT>
void WtVertexType<VERTEX, WEIGHT>::DisplayEdgelist(int wt) const {
...
template <class VERTEX, class WEIGHT>
void WtVertexType<VERTEX, WEIGHT>::WriteEdgelist(ostream &_myostream,
                                                 int wt) const {
...
// WtEdgeType<VERTEX,WEIGHT>*
typename vector<WtEdgeType<VERTEX, WEIGHT>>::iterator
WtVertexType<VERTEX, WEIGHT>::my_find_EID1_eq(const EID _eid) {
...
// WtEdgeType<VERTEX,WEIGHT>*
typename vector<WtEdgeType<VERTEX, WEIGHT>>::const_iterator
WtVertexType<VERTEX, WEIGHT>::my_find_EID2_eqc(CEI _start, CEI _end,
...
template <class VERTEX, class WEIGHT>
typename vector<WtEdgeType<VERTEX, WEIGHT>>::iterator
WtVertexType<VERTEX, WEIGHT>::my_find_EID2_eq(EI _start, EI _end,
                                              const EID _eid) {
  EI ei = _start;
  bool found = false;
  while (ei != _end && !found) {
...
// WtEdgeType<VERTEX,WEIGHT>*
typename vector<WtEdgeType<VERTEX, WEIGHT>>::const_iterator
WtVertexType<VERTEX, WEIGHT>::my_find_EIDWT_eqc(
...
template <class VERTEX, class WEIGHT>
typename vector<WtEdgeType<VERTEX, WEIGHT>>::iterator
WtVertexType<VERTEX, WEIGHT>::my_find_EIDWT_eq(
    const pair<VID, WEIGHT> _wtpair) {
  EI ei = edgelist.begin();
  // EI ei = const_cast<EI> (cei);
...
#ifdef _PGRAPH
template <class VERTEX, class WEIGHT>
WtEdgeType<VERTEX, WEIGHT>::WtEdgeType(VID _v2id, WEIGHT _weight, int _eid) {
  vertex2id = _v2id;
  weight = _weight;
  edgeid = _eid;
}
...
template <class VERTEX, class WEIGHT>
void WtEdgeType<VERTEX, WEIGHT>::DisplayEdge(int wt) const {
  cout << vertex2id;
  if (wt == 1)
    cout << "(" << weight << ")";
}
...
template <class VERTEX, class WEIGHT>
void WtEdgeType<VERTEX, WEIGHT>::WriteEdge(ostream &_myostream, int wt) const {
