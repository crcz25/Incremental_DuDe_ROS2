...
struct sk_node {
  ...
  static sk_node InvalidData() { return sk_node(); }
...
// typedef
// Graph<UG<sk_node,sk_edge>,NMG<sk_node,sk_edge>,WG<sk_node,sk_edge>,sk_node,sk_edge>
// SKG; typedef WeightedGraph<sk_node,sk_edge> SKG; typedef WG<sk_node, sk_edge>
// SKG;
